...
-- ------------------------------------------------------------
GO
CREATE OR ALTER VIEW customers_clean AS
...
-- ------------------------------------------------------------
GO
CREATE OR ALTER VIEW max_complete_clients AS
...
-- ------------------------------------------------------------
GO
CREATE OR ALTER VIEW completed_offers AS
...
-- ------------------------------------------------------------
GO
CREATE OR ALTER VIEW offer_results AS
WITH cte_timebin AS (
    SELECT *,
        CASE
